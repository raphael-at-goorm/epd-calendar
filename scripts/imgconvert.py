...
parser.add_argument('-w', action="store", dest="width",  type=int, default=SCREEN_WIDTH)
parser.add_argument('-H', action="store", dest="height", type=int, default=SCREEN_HEIGHT)
